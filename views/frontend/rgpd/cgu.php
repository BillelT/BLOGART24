...
<section class="CGU" style="background-color: #FEF5EA;">
        ...
        <div class="title-presentation" style="padding-top: 64px ;">
            <h2>Conditions Générales D'Utilisation</h2>
            <br> <br>
            <p>
                Ce site web est exploité par Bibble's. Partout sur le site, nous employons les termes « nous », « notre » et « nos » en référence à Bibble's. Ce site web, y compris l'ensemble des informations, outils et services auxquels il donne accès, est offert par Bibble's à l'utilisateur que vous êtes, à condition que vous acceptiez la totalité des modalités, conditions, politiques et avis stipulés ici. <br> <br>
                ...
                Notre site est hébergé sur (Ajouter hébergeur).
                
            </p>
        </div>
        <br> 
        <div class="section1-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 1 - CONDITIONS D'UTILISATION DU BLOG EN LIGNE</h3>
            <br>
            <p>
                ...
                Vous ne devez en aucune façon utiliser notre contenu à des fins illégales ou non autorisées, ni violer des lois de votre juridiction lorsque vous utilisez le Service (y compris, sans toutefois s'y limiter, les lois relatives aux droits d'auteur). <br> <br>
                
                Vous ne devez pas transmettre de vers informatiques, de virus ou tout code de nature destructrice. <br> <br>
        ...
        <br>
        <div class="section2-title" style="background-color: #FEF5EA;">
        ...
        <br>
        <div class="section3-title" style="background-color: #FEF5EA;">
        ...
        <br>
        <div class="section4-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 4 - MODIFICATIONS DU SERVICE ET DES PRIX</h3>
            <br>
            <p>
                Nous nous réservons le droit de modifier ou de mettre fin au Service (ou à une quelconque partie de celui-ci) à tout moment et sans préavis. <br> <br>

                Nous ne pourrons être tenus responsables envers vous ou tout tiers de toute modification, suspension ou interruption du Service.
            </p>
        </div>
        <br>
        <div class="section5-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 5 - OUTILS FACULTATIFS</h3>
            <br>
            <p>
        ...
        <br>
        <div class="section6-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 6 - LIENS DE TIERS</h3>
            <br>
            <p>
                Certains contenus et services accessibles via notre Service peuvent inclure des éléments provenant de tiers. <br> <br>
        ...
        <br>
        <div class="section8-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 8 - INFORMATIONS PERSONNELLES</h3>
            <br>
            <p>
                La transmission de vos informations personnelles sur notre blog est régie par notre Politique de confidentialité.  Cliquez ici pour consulter notre Politique de Confidentialité.
            </p>
        </div>
        <br>
        <div class="section9-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 9 - ERREURS, INEXACTITUDES ET OMISSIONS</h3>
            <br>
            <p> 
                Il se peut qu'il y ait parfois, sur notre site ou dans le Service, des informations contenant des erreurs typographiques, des inexactitudes ou des omissions reliées aux descriptions. Nous nous réservons le droit de corriger toute erreur, inexactitude ou omission, et de changer ou d'actualiser des informations, et ce, à tout moment et sans préavis. <br> <br>

                Nous ne sommes pas tenus d'actualiser, de modifier ou de clarifier les informations indiquées dans le Service ou sur tout site web connexe, y compris mais sans s'y limiter, sauf si la loi l'exige. Aucune date précise de mise à jour ou d'actualisation appliquée au Service ou à tout site web connexe ne saurait être définie pour indiquer que l'ensemble des informations offertes dans le Service ou sur tout site web connexe ont été modifiées ou mises à jour.
            </p>
        </div>
        <br>
        <div class="section10-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 10 - UTILISATIONS INTERDITES</h3>
            <br>
            <p> 
                En plus des autres interdictions énoncées dans les Conditions d'utilisation, il vous est interdit d'utiliser le site ou son contenu : <br> <br>
                (a) à des fins illégales ; (b) pour inciter des tiers à réaliser des actes illégaux ou à y prendre part ; (c) pour enfreindre toute ordonnance locale ou toute réglementation, règle ou loi internationale, fédérale, provinciale ou étatique ; (d) pour transgresser ou violer nos droits de propriété intellectuelle ou ceux de tiers ; (e) pour harceler, maltraiter, insulter, blesser, diffamer, calomnier, dénigrer, intimider ou discriminer quiconque en fonction du sexe, de l'orientation sexuelle, de la religion, de l'origine ethnique, de la race, de l'âge, de l'origine nationale ou d'un handicap ; (f) pour soumettre des renseignements faux ou trompeurs ; <br> <br>
        ...
        <br>
        <div class="section11-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 11 - EXCLUSION DE GARANTIES ET LIMITATION DE RESPONSABILITÉ</h3>
            <br>
            <p> 
                Nous ne garantissons, certifions ou déclarons en aucun cas que votre utilisation de notre Service sera ininterrompue, sécurisée, sans délai ou sans erreur. <br> <br>

                Nous ne garantissons pas que les résultats qui pourraient être obtenus en utilisant le Service seront exacts ou fiables. <br> <br>
        ...
        <br>
        <div class="section14-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 14 - INTÉGRALITÉ DE L'ACCORD</h3>
            <br>
            <p> 
                Tout manquement de notre part à l'exercice ou à l'application d'un droit ou d'une disposition des présentes Conditions d'utilisation ne constitue pas une renonciation à ce droit ou à cette disposition. <br> <br>

                Les présentes Conditions d'utilisation ou toute autre politique ou règle d'exploitation que nous publions sur ce site ou qui concernent le Service constituent l'intégralité de l'entente et de l'accord entre vous et nous, et régissent votre utilisation du Service. Elles remplacent l'ensemble des accords, communications et propositions antérieurs et actuels, oraux ou écrits, entre vous et nous (y compris, mais sans s'y limiter, toute version antérieure des Conditions d'utilisation). <br> <br>
        ...
        <br>
        <div class="section15-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 15 - LOI APPLICABLE</h3>
            <br>
            <p> 
                Les présentes Conditions d'utilisation, ainsi que tout accord distinct par lequel nous vous fournissons les Services sont régis et interprétés en vertu des lois de BORDEAUX, Gironde, 33230, France.
            </p>
        </div>
        <br>
        <div class="section16-title" style="background-color: #FEF5EA;">
            <h3>ARTICLE 16 - MODIFICATIONS APPORTÉES AUX CONDITIONS D'UTILISATION</h3>
            <br>
            <p>
                Vous pouvez consulter la version la plus récente des Conditions d'utilisation à tout moment sur cette page. <br> <br>
        ...
        <br>
        <div class="section17-title" style="background-color: #FEF5EA; padding-bottom: 64px;">
            <h3>ARTICLE 17 - COORDONNÉES</h3>
            <br>
            <p>
                Les questions relatives aux Conditions d'utilisation doivent nous être envoyées à antoine.corberand@mmibordeaux.com.
            </p>
        </div>  
</section>
